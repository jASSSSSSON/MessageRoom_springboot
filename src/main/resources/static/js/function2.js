...
function ose(){
	document.getElementById("se").style.background="url(/image/se2.png)";
	}
function lse(){
	document.getElementById("se").style.background="url(/image/se.png)";
	}
function pd(){
	var zt=document.getElementById("gr").innerHTML;
	if(zt=="访客")
		return false;
	else
		return true;
